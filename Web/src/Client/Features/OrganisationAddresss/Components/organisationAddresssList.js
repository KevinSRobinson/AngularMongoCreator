...
controllerAs: 'vm',
templateUrl: 'Features/OrganisationAddresss/Components/organisationAddresssList.html',
...
angular.module('app').component('organisationAddresssList', organisationAddresssList);
